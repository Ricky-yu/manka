...
class MankaPageController: MankaBaseController {
    
    var pageStyle:MankaPageStyle!
    ...
    convenience init(titles: [String] = [], vcs: [UIViewController] = [], pageStyle: MankaPageStyle = .none) {
        self.init()
        self.titles = titles
        self.vcs = vcs
...
extension MankaPageController: UIPageViewControllerDataSource, UIPageViewControllerDelegate {
