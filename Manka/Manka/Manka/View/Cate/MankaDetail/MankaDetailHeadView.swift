...
class MankaComicHeadCollectionCell: MankaBaseCollectionViewCell {
...
class MankaDetailHeadView: UIView {
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(cellType: MankaComicHeadCollectionCell.self)
    ...
    var detailStatic: MankaComicStaticModel? {
        didSet {
    ...
    var detailRealtime: MankaComicRealtimeModel? {
        didSet {
...
extension MankaDetailHeadView: UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return themes?.count ?? 0
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(for: indexPath, cellType: MankaComicHeadCollectionCell.self)
